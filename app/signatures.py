...
pyrun_simplestring = (
    rb"\x55\x8B\xEC\x6A\x00\xFF\x75\x08\xE8\x43\xCC\xFF\xFF\x83\xC4\x08\x5D"
)
...
cutscene_pattern = (
    rb"\x6F\x72\x69\x67\x69\x6E\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x6E\x61\x6D\x65"
)
...
npc_monster_byte_pattern = (
    rb"[\x10\x04][\x82\x94]......\x90\x7B..[\xE3\xE4\xE5\xE6\xE7\xE8\xE9]"
)
#                                ^ monster ^
#                                    ^   npc   ^
...
player_name_byte_pattern = (
    rb"\x00\x00\x00\x00\x00\x08..\x01.......\x01[\xE3\xE4\xE5\xE6\xE7\xE8\xE9]"
)
